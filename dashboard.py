...
def main():
    ...
    st.write(
        "This dashboard displays the processed data and allows stakeholders "
        "to filter and search the records."
    )
    ...
    if data.empty:
        st.warning(
            "No data to display. Please ensure the dataset is processed and available."
        )
        return
